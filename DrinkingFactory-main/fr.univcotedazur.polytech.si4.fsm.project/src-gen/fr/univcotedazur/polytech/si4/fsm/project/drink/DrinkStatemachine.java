...
public class DrinkStatemachine implements IDrinkStatemachine {
	protected class SCInterfaceImpl implements SCInterface {
		...
		private boolean byNFC;
		
		public synchronized boolean getByNFC() {
			synchronized(DrinkStatemachine.this) {
				return byNFC;
			}
		}
	...
	public synchronized boolean isStateActive(State state) {
		...
		case main_region_Customer:
			return stateVector[0].ordinal() >= State.
					main_region_Customer.ordinal()&& stateVector[0].ordinal() <= State.main_region_Customer_active_active.ordinal();
		case main_region_Customer_r1_initial:
	...
	*/
	...
	public synchronized boolean getByNFC() {
		return sCInterface.getByNFC();
	}
	
	public synchronized void setByNFC(boolean value) {
		sCInterface.setByNFC(value);
	}
	...
	private boolean main_region_Customer_r1_initial_react(boolean try_transition) {
		...
		if (try_transition) {
			if (((sCInterface.chooseCoin) && (sCInterface.getByNFC()==false))) {
				exitSequence_main_region_Customer_r1_initial();
